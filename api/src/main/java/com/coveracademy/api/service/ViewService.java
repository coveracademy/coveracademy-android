...
public class ViewService extends RestService {
  ...
  public Promise<UserView> userView(long userId) {
  ...
  public Promise<List<Comment>> commentsView(Video video) {
