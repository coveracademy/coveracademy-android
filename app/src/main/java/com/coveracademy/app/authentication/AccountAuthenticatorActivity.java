...
public class AccountAuthenticatorActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    accountAuthenticatorResponse = getIntent().getParcelableExtra(android.accounts.AccountManager.KEY_ACCOUNT_AUTHENTICATOR_RESPONSE);
  ...
  public void finish() {
    if(accountAuthenticatorResponse != null) {
      ...
      if(resultBundle != null) {
        ...
        accountAuthenticatorResponse.onError(android.accounts.AccountManager.ERROR_CODE_CANCELED, "canceled");
      }
